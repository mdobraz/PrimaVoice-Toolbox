function [peak_threshold, extent_threshold,Cluster_threshold, ...
...
if cluster_threshold > tlim
   ...
   fprintf('Cluster Threshold = %1.2f\n',Cluster_threshold)
end
...
if cluster_threshold > tlim
    fprintf('Cluster Threshold prob = %g\n',p)
end
...
fprintf('Extent Threshold (volume) = %1.2f\n',extent_threshold)
